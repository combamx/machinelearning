...
class BuscarPalabraResena implements ShouldQueue
{
    ...
    private function InicioTaggeoNotas(){
        try{
            echo "===== Iniciando busqueda en la Reseña ".date("H:i:s")." =====\n";
            ...
            echo "===== Terminando la busqueda en la Reseña ".date("H:i:s")." =====\n";
    ...
    private function TaggeoNews($news, $json_estado)
    {
        try{
            ...
            foreach($json_estado as $estado){
                ...
                $newNews = "public/taggeo/" . $news->id . "-resena-" . str_replace(array(" ", "á", "é", "í", "ó", "ú", "ñ"), array("-", "a", "e", "i", "o", "u", "n"), strtolower($estado->estado)). "-" . date("Y-m-d-H-i-s") . ".json";
                ...
                if ($news->content == "") {
                    ...
                    if (strpos($cadena_resena, $cadena_estado) !== false) {
                        ...
                        foreach ($json_municipios as $municipio) {
                            ...
                            if (strpos($cadena_resena, $cadena_buscada_mun) !== false || strpos($cadena_resena, $cadena_buscada_est_mun) !== false) {
                                ...
                                foreach ($json_asentamientos as $asentamiento) {
                                    ...
                                    if (strpos($cadena_resena, $cadena_buscada_asen) !== false || strpos($cadena_resena, $cadena_buscada_asen_min) !== false) {
